...
# On calcul la quantité totale de consommation de CO2 par source et par année
co2_by_year_source = df.pivot_table(index='SOURCEYEAR', columns='ENS_NAME', values='ENSCONSUMPTION', aggfunc='sum', fill_value=0)

# on affiche le graphique en aires empilées
fig, ax = plt.subplots(figsize=(12, 8))
co2_by_year_source.plot(kind='area', stacked=True, ax=ax, colormap='viridis')
ax.set_xlabel('Année')
ax.set_ylabel('Consommation de CO2 (en kg)')
ax.set_title('Consommation de CO2 par source en '+pays)
